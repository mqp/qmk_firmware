...
#define UTIL 1 /* media keys, LED controls, arrow keys, fn keys */
...
[BASE] = LAYOUT_ergodox(
  ...
  KC_TRNS, KC_TRNS, MO(UTIL), KC_LGUI, KC_LALT,
                                               KC_INS,  KC_NLCK,
                                                        KC_CAPS,
...
/* Keymap 1: F-Keys, arrow keys, media, lighting
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
